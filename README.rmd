...
run
-v "/$(pwd)"/report:/home/rstudio/project/final_project <image_tag>" in the bash terminal.($there is "space" after -v ) image_tag- use same name used to build an image. "/$(pwd)“-
