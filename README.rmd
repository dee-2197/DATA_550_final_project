...
run
-v "/$(pwd)"/report:/home/rstudio/project/final_project <image_tag>" in the bash terminal.(there is "space" after -v )(note: /$(pwd)is in quotation). image_tag- use same name used to build an image. "/$(pwd)“-
...
“make” to build report and type “mv final_project.html final_project_output” in
order to view report in "report - folder" in local directory
