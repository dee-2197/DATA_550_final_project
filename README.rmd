...
We can use make command “make final_project_output/final_project.html” in bash
terminal. It Will build an image and generate report automatically,
which can be accessed in final_project_output directory in your local machine
