...
run
-v”/$(pwd)"/report:/home/rstudio/project/final_project <image_tag>" in the bash terminal.(there is "space" after -v )(note: /$(pwd)is
in quotation (““)). image_tag- use same name used to build an
image.”/\$(pwd)“- command substitution for working directory and in
quotations as has space, We used extra / as using windows operating
...
bash terminal, in order to view report in “report - folder” in local
directory
